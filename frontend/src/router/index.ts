...
const routes = [
  ...
  { path: '/papers', name: 'TruePaperLibrary', component: () => import('../views/practice/TruePaperLibrary.vue'), meta: { requiresAuth: true } },
  ...
  { path: '/report', name: 'GrowthReport', component: () => import('../views/report/ReportPage.vue'), meta: { requiresAuth: true } },
