...
const routes = [
  ...
  { path: '/history', component: () => import('../views/AppLayout.vue'), meta: { requiresAuth: true }, children: [{ path: '', name: 'PracticeHistory', component: () => import('../views/practice/PracticeHistory.vue') }] },
  ...
  { path: '/wrongbook', redirect: '/history' },
  ...
  { path: '/app/history', redirect: '/history' },
  { path: '/app/wrongbook', redirect: '/history' },
